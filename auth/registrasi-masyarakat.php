			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="" method="post" >
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" type="number" name="nik" id="nik" size="25" placeholder="Nik" >
					</div>

					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="nama" id="nama" size="25" placeholder="Nama" >
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<input class="input100" type="password" name="password2" id="password2" size="25" placeholder="Password Konfimasi" >
					</div>
					...
					<div class="text-center p-t-115">
						...
						<a class="txt2" href="login-masyarakat.php">
							Masuk
						</a>
					</div>
				</form>
